          ...
          <table class="table table-hover align-middle mb-0">
            <thead class="bg-light text-muted small text-uppercase">
              <tr>
                ...
                <th class="border-0">Nombre del Distrito</th>
            ...
            <tbody>
              <tr v-for="distrito in distritos" :key="distrito.id">
                ...
                <td>
                  <span v-if="distrito.estado == 1 || distrito.estado === true"
...
.btn-primary:active, .btn-primary:focus { background-color: var(--primary-color) !important; opacity: 0.9; }
